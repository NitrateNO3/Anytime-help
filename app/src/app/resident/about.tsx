    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.text}>
          Welcome to Anytime Help. {"\n\n"}
          Anytime Help is a premium society management platform designed to make community living seamless and secure. {"\n\n"}
          Our mission is to bridge the gap between residents and society administration by providing instant access to essential services like plumbing, electrical work, and cleaning, all at your fingertips. {"\n\n"}
          Version: 1.0.0
        </Text>
      </ScrollView>
    </SafeAreaView>
