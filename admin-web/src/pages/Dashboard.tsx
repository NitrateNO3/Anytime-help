                ...
                {loading ? (
                  ...
                  complaints.map(item => (
                    <tr key={item._id}>
                      ...
                      <td>
                        <div style={{ color: (item.user?.address || item.user?.room_number) ? 'var(--text-main)' : 'var(--text-muted)', fontSize: 13 }}>
                          {item.user?.address || (item.user?.room_number ? `${item.user.room_number}${item.user.phase ? `, ${item.user.phase}` : ''}` : '-')}
                        </div>
                      </td>
                      <td>
